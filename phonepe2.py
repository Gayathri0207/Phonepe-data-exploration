...
cursor = mydb.cursor()
#created tables in the database.Avoided in script to avoid handshake error 
...
with tab1:
    ...
    with col2:
        st.video("C:\\Users\\Gayathri\\OneDrive\\Desktop\\phonepe project\\PhonePe_ad.mp4")

    col3,col4= st.columns(2)
    
    with col3:
        st.video("C:\\Users\\Gayathri\\OneDrive\\Desktop\\phonepe project\\PhonePe Motion Graphics(1).mp4")
    ...
    with col6:
        st.video("C:\\Users\\Gayathri\\OneDrive\\Desktop\\phonepe project\\PhonePe Motion Graphics.mp4")
